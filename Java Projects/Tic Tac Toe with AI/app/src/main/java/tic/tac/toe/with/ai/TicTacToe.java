...
class TicTacToe {
    ...
    TicTacToe(String playerOne, String playerTwo) {
        ...
        switch (playerOne) {
            case "user" -> firstManeuver = new HumanManeuver();
            case "easy" -> firstManeuver = new EasyCpuManeuver();
            case "medium" -> firstManeuver = new MediumCpuManeuver();
            case "hard" -> firstManeuver = new HardCPUManeuver();
        }

        switch (playerTwo) {
            case "user" -> secondManeuver = new HumanManeuver();
            case "easy" -> secondManeuver = new EasyCpuManeuver();
            case "medium" -> secondManeuver = new MediumCpuManeuver();
            case "hard" -> secondManeuver = new HardCPUManeuver();
        }
    }
